...
function TabsTrigger({
  ...
  return (
    <TabsPrimitive.Trigger
      ...
      style={{
        '--tabs-line-color': 'var(--foreground)',
        ...style,
      ...
      className={cn(
        ...
        "after:absolute after:bg-[var(--tabs-line-color)] after:opacity-0 after:transition-opacity group-data-horizontal/tabs:after:inset-x-0 group-data-horizontal/tabs:after:bottom-[var(--tabs-line-bottom,-5px)] group-data-horizontal/tabs:after:h-0.5 group-data-vertical/tabs:after:inset-y-0 group-data-vertical/tabs:after:-right-1 group-data-vertical/tabs:after:w-0.5 group-data-[variant=line]/tabs-list:data-active:after:opacity-100",
        className
      )}
      {...props}
    />
